...
import com.fomdev.awaken.bonus.LootBonusInstance;
...
public class AwakenRegistries
{
    ...
    public static final String SIG_AWAKEN_LOOT      = "awaken_loot";
    ...
    public static final ResourceKey<Registry<LootBonusInstance>> AWAKEN_LOOT;
    public static final ResourceKey<Registry<Pollinate>>         AWAKEN_POLLINATE;
    ...
    public static final ResourceKey<Registry<Spore>>             AWAKEN_SPORE;
    ...
    static
    {
        ...
        AWAKEN_LOOT = register(SIG_AWAKEN_LOOT);
        AWAKEN_POLLINATE = register(SIG_AWAKEN_POLLINATE);
        AWAKEN_PREFIX = register(SIG_AWAKEN_PREFIX);
        AWAKEN_QUALITY = register(SIG_AWAKEN_QUALITY);
        AWAKEN_SPORE = register(SIG_AWAKEN_SPORE);
